...
const { createItem, getItems, updateStock, deleteItem, updateReorder, reduceStock, updateItem } = require("../controllers/inventory.controller");
...
router.put("/:itemId", verifyToken, authorizeRoles("admin", "manager"), updateItem);
